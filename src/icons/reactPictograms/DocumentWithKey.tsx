...
export const DocumentWithKey = React.forwardRef<SVGSVGElement, PictogramIconProps>(
    ({ width = 64, height = 64, ...props }, forwardedRef) => {
        return (
            <SVGPictogramWrapper icon={PictogramsNames.DocumentWithKey} {...props}>
                <svg
                    width={width}
                    height={height}
                    ref={forwardedRef}
                    ...
                    <g className="isolate">
                        <g id="Layer_1" data-name="Layer 1">
                            ...
                            <g className="mix-blend-multiply">
                                <path
                                    className="base"
                                    d="M22.31,1.14V12.9a1.94,1.94,0,0,1-.59,1.38,2.08,2.08,0,0,1-1.42.58H8.18Z"
                                />
                            </g>
                            <g className="mix-blend-multiply">
...
DocumentWithKey.displayName = "DocumentWithKey";

export default DocumentWithKey;
