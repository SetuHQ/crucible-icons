...
export const MobileWithNotification = React.forwardRef<SVGSVGElement, PictogramIconProps>(
    ({ width = 64, height = 64, ...props }, forwardedRef) => {
        return (
            <SVGPictogramWrapper icon={PictogramsNames.MobileWithNotification} {...props}>
                <svg
                    width={width}
                    height={height}
                    ref={forwardedRef}
                ...
                >
                    ...
                    <g className="isolate">
                        <g id="Layer_1" data-name="Layer 1">
                            ...
                            />
                            <path className="secondary" d="M55.9,21.36a1,1,0,1,0-1.94,0v1.07a1,1,0,0,0,1.94,0Z" />
                        </g>
                    </g>
                </svg>
            </SVGPictogramWrapper>
...
MobileWithNotification.displayName = "MobileWithNotification";

export default MobileWithNotification;
