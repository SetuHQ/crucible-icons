...
export const IdCard = React.forwardRef<SVGSVGElement, PictogramIconProps>(
    ({ width = 64, height = 64, ...props }, forwardedRef) => {
        return (
            <SVGPictogramWrapper icon={PictogramsNames.IdCard} {...props}>
                <svg
                    width={width}
                    height={height}
                    ref={forwardedRef}
                        ...
                        <g id="Layer_1" data-name="Layer 1">
                            <g clipPath="url(#clipPath)">
                                ...
                                <g className="mix-blend-multiply">
                                    <path
                                        className="base"
                                        d="M30.5,24.82H7.5a1.5,1.5,0,0,0,0,3h23a1.5,1.5,0,0,0,0-3Z"
                                    />
                                </g>
                                <path className="primary" d="M40.5,14.82H7.5a1.5,1.5,0,0,0,0,3h33a1.5,1.5,0,0,0,0-3Z" />
                                <g className="mix-blend-multiply">
                                    <path
                                        className="base"
                                        d="M21.5,30.82H7.5a1.5,1.5,0,0,0,0,3h14a1.5,1.5,0,0,0,0-3Z"
                                    />
                                </g>
                                <g className="mix-blend-multiply">
                                    <path className="base" d="M60.11,27.19H37.88V49.82H60.11Z" />
                                </g>
                                <path
                                    className="base"
                                    d="M48.83,41.79A4.87,4.87,0,1,0,44,36.92,4.86,4.86,0,0,0,48.83,41.79Z"
                                />
