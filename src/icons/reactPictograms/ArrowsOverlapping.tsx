...
export const ArrowsOverlapping = React.forwardRef<SVGSVGElement, PictogramIconProps>(
    ({ width = 64, height = 64, ...props }, forwardedRef) => {
        return (
            <SVGPictogramWrapper icon={PictogramsNames.ArrowsOverlapping} {...props}>
                <svg
                    width={width}
                    height={height}
                    ref={forwardedRef}
...
ArrowsOverlapping.displayName = "ArrowsOverlapping";

export default ArrowsOverlapping;
