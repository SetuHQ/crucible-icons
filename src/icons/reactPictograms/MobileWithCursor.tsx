...
export const MobileWithCursor = React.forwardRef<SVGSVGElement, PictogramIconProps>(
    ({ width = 64, height = 64, ...props }, forwardedRef) => {
        return (
            <SVGPictogramWrapper icon={PictogramsNames.MobileWithCursor} {...props}>
                <svg
                    width={width}
                    height={height}
                    ref={forwardedRef}
                ...
                >
                    ...
                    <g className="isolate">
                        <g id="Layer_1" data-name="Layer 1">
                            ...
                            <g className="base mix-blend-multiply">
                                <path className="base" d="M27,58h3a2,2,0,0,1,0,4H27a2,2,0,0,1,0-4Z" />
                            </g>
                            <g className="base mix-blend-multiply">
                                <path
                                    className="primary"
...
MobileWithCursor.displayName = "MobileWithCursor";

export default MobileWithCursor;
