...
export const StampWithTick = React.forwardRef<SVGSVGElement, PictogramIconProps>(
    ({ width = 64, height = 64, ...props }, forwardedRef) => {
        return (
            <SVGPictogramWrapper icon={PictogramsNames.StampWithTick} {...props}>
                <svg
                    width={width}
                    height={height}
                    ref={forwardedRef}
...
StampWithTick.displayName = "StampWithTick";

export default StampWithTick;
