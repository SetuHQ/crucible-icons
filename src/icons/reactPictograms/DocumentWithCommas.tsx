...
export const DocumentWithCommas = React.forwardRef<SVGSVGElement, PictogramIconProps>(
    ({ width = 64, height = 64, ...props }, forwardedRef) => {
        return (
            <SVGPictogramWrapper icon={PictogramsNames.DocumentWithCommas} {...props}>
                <svg
                    width={width}
                    height={height}
                    ref={forwardedRef}
...
DocumentWithCommas.displayName = "DocumentWithCommas";

export default DocumentWithCommas;
