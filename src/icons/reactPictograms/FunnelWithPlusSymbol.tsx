...
export const FunnelWithPlusSymbol = React.forwardRef<SVGSVGElement, PictogramIconProps>(
    ({ width = 64, height = 64, ...props }, forwardedRef) => {
        return (
            <SVGPictogramWrapper icon={PictogramsNames.FunnelWithPlusSymbol} {...props}>
                <svg
                    width={width}
                    height={height}
                    ref={forwardedRef}
...
FunnelWithPlusSymbol.displayName = "FunnelWithPlusSymbol";

export default FunnelWithPlusSymbol;
