...
export const Book = React.forwardRef<SVGSVGElement, PictogramIconProps>(
    ({ width = 64, height = 64, ...props }, forwardedRef) => {
        return (
            <SVGPictogramWrapper icon={PictogramsNames.Book} {...props}>
                <svg
                    width={width}
                    height={height}
                    ref={forwardedRef}
                ...
                >
                    ...
                    <g id="Layer_1" data-name="Layer 1">
                        ...
                        <path className="primary" d="M48,0V12H43V0l2.5,2.4Z" />
                        <path className="secondary" d="M41,0V12H36V0l2.5,2.4Z" />
                        <path
                            className="base"
                        ...
                        <g className="mix-blend-multiply">
                            <path
                                className="primary"
                                d="M39,21H23a1,1,0,0,0-1,1v2a1,1,0,0,0,1,1H39a1,1,0,0,0,1-1V22A1,1,0,0,0,39,21Z"
                            />
                        </g>
                    </g>
                </svg>
