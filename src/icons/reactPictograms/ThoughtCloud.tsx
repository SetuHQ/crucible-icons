...
export const ThoughtCloud = React.forwardRef<SVGSVGElement, PictogramIconProps>(
    ({ width = 64, height = 64, ...props }, forwardedRef) => {
        return (
            <SVGPictogramWrapper icon={PictogramsNames.ThoughtCloud} {...props}>
                <svg
                    width={width}
                    height={height}
                    ref={forwardedRef}
                ...
                >
                    ...
                    <g className="isolate">
                        <g id="Layer_1" data-name="Layer 1">
                            ...
                            <path
                                className="secondary"
                                d="M9.74,9.58,11.15,7l1.42,2.58L15.16,11l-2.59,1.41L11.15,15,9.74,12.41,7.16,11Z"
                            />
                            <path
                                className="base"
...
ThoughtCloud.displayName = "ThoughtCloud";
