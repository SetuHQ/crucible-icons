...
export const WindowWithCodeAndBraces = React.forwardRef<SVGSVGElement, PictogramIconProps>(
    ({ width = 64, height = 64, ...props }, forwardedRef) => {
        return (
            <SVGPictogramWrapper icon={PictogramsNames.WindowWithCodeAndBraces} {...props}>
                <svg
                    width={width}
                    height={height}
                    ref={forwardedRef}
                ...
                >
                    ...
                    <g className="isolate">
                        <g id="Layer_1" data-name="Layer 1">
                            ...
                            <path className="primary" d="M29,21H9a1,1,0,0,0,0,2H29a1,1,0,0,0,0-2Z" />
                            <path className="tertiary" d="M19,25H9a1,1,0,0,0,0,2H19a1,1,0,0,0,0-2Z" />
                            <path className="secondary" d="M12,29H9a1,1,0,0,0,0,2h3a1,1,0,0,0,0-2Z" />
                            <path className="tertiary" d="M32,29H16a1,1,0,0,0,0,2H32a1,1,0,0,0,0-2Z" />
                            <path className="primary" d="M25,33H9a1,1,0,0,0,0,2H25a1,1,0,0,0,0-2Z" />
...
WindowWithCodeAndBraces.displayName = "WindowWithCodeAndBraces";

export default WindowWithCodeAndBraces;
