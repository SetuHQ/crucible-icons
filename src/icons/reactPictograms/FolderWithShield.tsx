...
export const FolderWithShield = React.forwardRef<SVGSVGElement, PictogramIconProps>(
    ({ width = 64, height = 64, ...props }, forwardedRef) => {
        return (
            <SVGPictogramWrapper icon={PictogramsNames.FolderWithShield} {...props}>
                <svg
                    width={width}
                    height={height}
                    ref={forwardedRef}
...
FolderWithShield.displayName = "FolderWithShield";

export default FolderWithShield;
