...
export const TabletWithPen = React.forwardRef<SVGSVGElement, PictogramIconProps>(
    ({ width = 64, height = 64, ...props }, forwardedRef) => {
        return (
            <SVGPictogramWrapper icon={PictogramsNames.TabletWithPen} {...props}>
                <svg
                    width={width}
                    height={height}
                    ref={forwardedRef}
                ...
                >
                    ...
                    <g className="isolate">
                        <g id="Layer_1" data-name="Layer 1">
                            ...
                            />
                            <path className="base" d="M54.46,54a2,2,0,0,1-2,2h-38V52h38a2,2,0,0,1,2,2Z" />
                            <path
                                className="primary"
                            ...
                            />
                            <g className="mix-blend-multiply">
                                <path className="base" d="M54.46,54a2,2,0,0,1-2,2h-4V52h4a2,2,0,0,1,2,2Z" />
                            </g>
                            <path
                                className="mix-blend-multiply base"
                            ...
                            <g className="mix-blend-multiply">
                                <path className="base" d="M37.58,18h-27a1.5,1.5,0,0,0,0,3h27a1.5,1.5,0,0,0,0-3Z" />
                            </g>
                            <g className="mix-blend-multiply">
                                <path className="base" d="M27.58,24h-17a1.5,1.5,0,0,0,0,3h17a1.5,1.5,0,0,0,0-3Z" />
                            </g>
                        </g>
                    </g>
                </svg>
...
TabletWithPen.displayName = "TabletWithPen";

export default TabletWithPen;
