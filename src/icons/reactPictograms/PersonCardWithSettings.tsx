...
export const PersonCardWithSettings = React.forwardRef<SVGSVGElement, PictogramIconProps>(
    ({ width = 64, height = 64, ...props }, forwardedRef) => {
        return (
            <SVGPictogramWrapper icon={PictogramsNames.PersonCardWithSettings} {...props}>
                <svg
                    width={width}
                    height={height}
                    ref={forwardedRef}
                ...
                >
                    ...
                    <g className="isolate">
                        <mask id="a" x="6.89" y="19.73" width="20.11" height="20.27" maskUnits="userSpaceOnUse">
                            <path
                                d="M17,39.84A10.06,10.06,0,1,1,27,29.79,10.08,10.08,0,0,1,17,39.84Z"
                                className="base"
                            />
                        </mask>
                        ...
                        <g className="mix-blend-multiply">
                            <path
                                d="M17,39.84A10.06,10.06,0,1,0,6.89,29.79,10.05,10.05,0,0,0,17,39.84Z"
                                className="base"
                            />
                        </g>
                        <g className="mix-blend-multiply">
                        ...
                        <g className="mix-blend-multiply">
                            <circle cx="17.16" cy="26.38" r="3.02" className="base" />
                        </g>
                        <rect x="32" y="20" width="21" height="3" rx="1.5" className="base mix-blend-multiply" />
                        <rect x="32" y="26" width="15" height="3" rx="1.5" className="base mix-blend-multiply" />
                        <g className="mix-blend-multiply">
                            <path
...
PersonCardWithSettings.displayName = "PersonCardWithSettings";

export default PersonCardWithSettings;
