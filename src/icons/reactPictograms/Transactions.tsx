...
export const Transactions = React.forwardRef<SVGSVGElement, PictogramIconProps>(
    ({ width = 64, height = 64, ...props }, forwardedRef) => {
        return (
            <SVGPictogramWrapper icon={PictogramsNames.Transactions} {...props}>
                <svg
                    width={width}
                    height={height}
                    ref={forwardedRef}
                ...
                >
                    ...
                    <g className="isolate">
                        <g id="Layer_1" data-name="Layer 1">
                            ...
                            <path
                                className="primary"
                                d="M59.81,25.43V45.82l-4.29-4.29-4.3,4.29V21.13h4.3a4.3,4.3,0,0,1,4.29,4.3Z"
                            />
