...
export const PeopleWithLeader = React.forwardRef<SVGSVGElement, PictogramIconProps>(
    ({ width = 64, height = 64, ...props }, forwardedRef) => {
        return (
            <SVGPictogramWrapper icon={PictogramsNames.PeopleWithLeader} {...props}>
                <svg
                    width={width}
                    height={height}
                    ref={forwardedRef}
                ...
                >
                    ...
                    <g className="isolate">
                        <g id="Layer_1" data-name="Layer 1">
                            ...
                            <path className="secondary" d="M32,63.79a16,16,0,1,0-6.15-1.19A16,16,0,0,0,32,63.79Z" />
                            <path
                                className="tertiary"
...
PeopleWithLeader.displayName = "PeopleWithLeader";

export default PeopleWithLeader;
