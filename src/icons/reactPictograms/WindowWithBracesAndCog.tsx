...
export const WindowWithBracesAndCog = React.forwardRef<SVGSVGElement, PictogramIconProps>(
    ({ width = 64, height = 64, ...props }, forwardedRef) => {
        return (
            <SVGPictogramWrapper icon={PictogramsNames.WindowWithBracesAndCog} {...props}>
                <svg
                    width={width}
                    height={height}
                    ref={forwardedRef}
...
WindowWithBracesAndCog.displayName = "WindowWithBracesAndCog";

export default WindowWithBracesAndCog;
