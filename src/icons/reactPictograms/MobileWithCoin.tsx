...
export const MobileWithCoin = React.forwardRef<SVGSVGElement, PictogramIconProps>(
    ({ width = 64, height = 64, ...props }, forwardedRef) => {
        return (
            <SVGPictogramWrapper icon={PictogramsNames.MobileWithCoin} {...props}>
                <svg
                    width={width}
                    height={height}
                    ref={forwardedRef}
                        ...
                        <g id="Layer_1" data-name="Layer 1">
                            <g clipPath="url(#clipPath)">
                                ...
                                <g className="mix-blend-multiply">
                                    <path className="base" d="M30,57H26a2,2,0,0,0,0,4h4a2,2,0,0,0,0-4Z" />
                                </g>
                                <g className="mix-blend-multiply">
                                    <path className="primary" d="M44,46a16,16,0,1,0-11.31-4.69A16,16,0,0,0,44,46Z" />
                                </g>
                                <path
                                    className="secondary"
...
MobileWithCoin.displayName = "MobileWithCoin";

export default MobileWithCoin;
