...
export const DocumentWithLock = React.forwardRef<SVGSVGElement, PictogramIconProps>(
    ({ width = 64, height = 64, ...props }, forwardedRef) => {
        return (
            <SVGPictogramWrapper icon={PictogramsNames.DocumentWithLock} {...props}>
                <svg
                    width={width}
                    height={height}
                    ref={forwardedRef}
...
DocumentWithLock.displayName = "DocumentWithLock";

export default DocumentWithLock;
