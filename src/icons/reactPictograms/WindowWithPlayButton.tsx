...
export const WindowWithPlayButton = React.forwardRef<SVGSVGElement, PictogramIconProps>(
    ({ width = 64, height = 64, ...props }, forwardedRef) => {
        return (
            <SVGPictogramWrapper icon={PictogramsNames.WindowWithPlayButton} {...props}>
                <svg
                    width={width}
                    height={height}
                    ref={forwardedRef}
...
WindowWithPlayButton.displayName = "WindowWithPlayButton";

export default WindowWithPlayButton;
