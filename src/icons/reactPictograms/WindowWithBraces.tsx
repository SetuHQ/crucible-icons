...
export const WindowWithBraces = React.forwardRef<SVGSVGElement, PictogramIconProps>(
    ({ width = 64, height = 64, ...props }, forwardedRef) => {
        return (
            <SVGPictogramWrapper icon={PictogramsNames.WindowWithBraces} {...props}>
                <svg
                    width={width}
                    height={height}
                    ref={forwardedRef}
...
WindowWithBraces.displayName = "WindowWithBraces";

export default WindowWithBraces;
