...
export const Parchment = React.forwardRef<SVGSVGElement, PictogramIconProps>(
    ({ width = 64, height = 64, ...props }, forwardedRef) => {
        return (
            <SVGPictogramWrapper icon={PictogramsNames.Parchment} {...props}>
                <svg
                    width={width}
                    height={height}
                    ref={forwardedRef}
                ...
                >
                    ...
                    <g className="isolate">
                        <g id="Layer_1" data-name="Layer 1">
                            ...
                            <path className="base" d="M56.12,11H8.05V53H56.12Z" />
                            <path
                                className="primary"
                            ...
                            <g className="mix-blend-multiply">
                                <path className="base" d="M49.47,37.17h-35a1.5,1.5,0,0,0,0,3h35a1.5,1.5,0,0,0,0-3Z" />
                            </g>
                            <g className="mix-blend-multiply">
                                <path className="base" d="M49.47,43.09h-35a1.5,1.5,0,0,0,0,3h35a1.5,1.5,0,0,0,0-3Z" />
                            </g>
                            <path
                                className="tertiary"
                            ...
                            <path
                                className="tertiary"
                                d="M2.53,56H4.07v5H2.53A2.53,2.53,0,0,1,0,58.5H0A2.53,2.53,0,0,1,2.53,56Z"
                            />
                            <path
                                className="tertiary"
                            ...
                            <path
                                className="tertiary"
                                d="M61.3,61H59.76V56H61.3a2.52,2.52,0,0,1,2.53,2.53A2.53,2.53,0,0,1,61.3,61Z"
                            />
                        </g>
                    </g>
                </svg>
