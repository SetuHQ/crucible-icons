...
export const DocumentWithBadgeAndTick = React.forwardRef<SVGSVGElement, PictogramIconProps>(
    ({ width = 64, height = 64, ...props }, forwardedRef) => {
        return (
            <SVGPictogramWrapper icon={PictogramsNames.DocumentWithBadgeAndTick} {...props}>
                <svg
                    width={width}
                    height={height}
                    ref={forwardedRef}
                        ...
                        <g id="Layer_1" data-name="Layer 1">
                            <g clipPath="url(#clipPath)">
                                ...
                                <g className="mix-blend-multiply">
                                    <path className="primary" d="M56,33l-4-4-4,4V22.33h8Z" />
                                    <path className="primary" d="M52,25a8,8,0,1,0-8-8A8,8,0,0,0,52,25Z" />
                                    <g className="mix-blend-multiply">
                                        <path
                                            className="primary"
                                            d="M52,22.48A5.48,5.48,0,1,0,46.52,17,5.48,5.48,0,0,0,52,22.48Z"
                                        />
                                    </g>
                                </g>
                                <g className="mix-blend-multiply">
                                    <path className="base" d="M22,58a8,8,0,1,1,5.65-2.35A8,8,0,0,1,22,58Z" />
                                </g>
                                <path
                                    className="secondary"
                                    fillRule="evenodd"
                                ...
                                />
                                <g className="mix-blend-multiply">
                                    <path className="base" d="M32.6,25H7.4a1.5,1.5,0,0,0,0,3H32.6a1.5,1.5,0,0,0,0-3Z" />
                                </g>
                                <g className="mix-blend-multiply">
                                    <path
                                        className="base"
                                        d="M23.58,32H7.42a1.5,1.5,0,0,0,0,3H23.58a1.5,1.5,0,0,0,0-3Z"
                                    />
                                </g>
                                <g className="mix-blend-multiply">
                                    <path
...
DocumentWithBadgeAndTick.displayName = "DocumentWithBadgeAndTick";

export default DocumentWithBadgeAndTick;
