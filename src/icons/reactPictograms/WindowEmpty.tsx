...
export const WindowEmpty = React.forwardRef<SVGSVGElement, PictogramIconProps>(
    ({ width = 64, height = 64, ...props }, forwardedRef) => {
        return (
            <SVGPictogramWrapper icon={PictogramsNames.WindowEmpty} {...props}>
                <svg
                    width={width}
                    height={height}
                    ref={forwardedRef}
...
WindowEmpty.displayName = "WindowEmpty";
