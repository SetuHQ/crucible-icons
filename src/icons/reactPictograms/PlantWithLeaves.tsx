...
export const PlantWithLeaves = React.forwardRef<SVGSVGElement, PictogramIconProps>(
    ({ width = 64, height = 64, ...props }, forwardedRef) => {
        return (
            <SVGPictogramWrapper icon={PictogramsNames.PlantWithLeaves} {...props}>
                <svg
                    width={width}
                    height={height}
                    ref={forwardedRef}
...
PlantWithLeaves.displayName = "PlantWithLeaves";

export default PlantWithLeaves;
