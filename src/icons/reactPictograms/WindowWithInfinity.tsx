...
export const WindowWithInfinity = React.forwardRef<SVGSVGElement, PictogramIconProps>(
    ({ width = 64, height = 64, ...props }, forwardedRef) => {
        return (
            <SVGPictogramWrapper icon={PictogramsNames.WindowWithInfinity} {...props}>
                <svg
                    width={width}
                    height={height}
                    ref={forwardedRef}
...
WindowWithInfinity.displayName = "WindowWithInfinity";

export default WindowWithInfinity;
